...
import { InstaCompoundIIIArbitrumResolver, InstaCompoundIIIArbitrumResolver__factory } from "../../typechain";

describe("Compound Resolvers", () => {
  let signer: SignerWithAddress;
  const user = "0x0a904e5e342d853952ad8159502dc1a29f9b084e";
  const markets = ["0xA5EDBDD9646f8dFF606d7448e414884C7d905dCA"];
  ...
  describe("Compound Resolver", () => {
    let resolver: InstaCompoundIIIArbitrumResolver;
    before(async () => {
      const deployer = new InstaCompoundIIIArbitrumResolver__factory(signer);
