...
describe("Morpho Resolvers", () => {
  ...
  describe("Morpho Resolver", () => {
    ...
    it("Returns the morpho's configurations", async () => {
      ...
      //   console.log(`isSupplyPaused: ${compMarket.flags.isSupplyPaused}`);
      //   console.log(`isBorrowPaused: ${compMarket.flags.isBorrowPaused}`);
      //   console.log(`isWithdrawPaused: ${compMarket.flags.isWithdrawPaused}`);
      //   console.log(`isRepayPaused: ${compMarket.flags.isRepayPaused}`);
      //   console.log(`isDeprecated: ${compMarket.flags.isDeprecated}`);
