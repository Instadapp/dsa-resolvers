...
describe("Compound Resolvers", () => {
  ...
  const markets = ["0xF25212E676D1F7F89Cd72fFEe66158f541246445"];
  ...
  describe("Compound Resolver", () => {
    let resolver: InstaCompoundIIIPolygonResolver;
    before(async () => {
      const deployer = new InstaCompoundIIIPolygonResolver__factory(signer);
