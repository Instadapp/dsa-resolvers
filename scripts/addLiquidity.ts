...
const tokenMapping: any = {
  usdc: {
    ...
    abi: tokenABI,
    process: async function (owner: any, to: any, amt: any) {
  ...
  usdt: {
    ...
    process: async function (owner: any, address: any, amt: any) {
      const contract = new ethers.Contract(this.address, this.abi, owner);
...
export default async (tokenName: any, address: any, amt: any) => {
