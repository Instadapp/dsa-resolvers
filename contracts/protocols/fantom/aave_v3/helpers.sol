...
contract AaveV3Helper is DSMath {
    ...
    function getUiDataProvider() internal pure returns (address) {
        return 0x1CCbfeC508da8D5242D5C1b368694Ab0066b39f1; //fantom UiPoolDataProvider Address
    }
    ...
    function getPoolAddressProvider() internal pure returns (address) {
        return 0xa97684ead0e402dC232d5A977953DF7ECBaB3CDb; //fantom PoolAddressesProvider address
    }
    ...
    function getPoolDataProvider() internal pure returns (address) {
        return 0x69FA688f1Dc47d4B5d8029D5a35FB7a548310654; //fantom PoolDataProvider address
    }
    ...
    function getAaveDataProvider() internal pure returns (address) {
        return 0x69FA688f1Dc47d4B5d8029D5a35FB7a548310654; //fantom address
    }

    function getAaveIncentivesAddress() internal pure returns (address) {
        return 0x6A83d738fCBaB0c3973234AC7b7b4f7DDa2aD248; //fantom IncentivesProxyAddress
    }
    ...
    function getAaveOracle() internal pure returns (address) {
        return 0xfd6f3c1845604C8AE6c6E402ad17fb9885160754; //fantom address
    }
    ...
    function getStableDebtToken() internal pure returns (address) {
        return 0xfAeF6A702D15428E588d4C0614AEFb4348D83D48; //fantom address
    }

    function getUiIncetivesProvider() internal view returns (address) {
        return 0xbA14c06011f4AF5970cFDe4364ba6320E190BD4B;
    }
