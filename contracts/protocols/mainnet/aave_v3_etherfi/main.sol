...
/**
 *@title Aave v3 Etherfi Resolver
 *@dev get user position, user configuration & reserves list.
 */
contract AaveV3EtherfiResolver is AaveV3Helper {
    /**
...
contract InstaAaveV3EtherfiResolver is AaveV3EtherfiResolver {
    string public constant name = "AaveV3-Etherfi-Resolver-v1.0";
}
