...
contract AaveV3Helper is DSMath {
    ...
    function getPoolAddressProvider() internal pure returns (address) {
        return 0xeBa440B438Ad808101d1c451C1C5322c90BEFCdA; //Mainnet PoolAddressesProvider address
    }
    ...
    function getPoolDataProvider() internal pure returns (address) {
        return 0x8Cb4b66f7B13F2Ae4D3c91338fC007dbF8C14208; //Mainnet PoolDataProvider address
    }
    ...
    function getAaveOracle() internal pure returns (address) {
        return 0x43b64f28A678944E0655404B0B98E443851cC34F; //Mainnet address
    }
