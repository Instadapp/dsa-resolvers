...
struct UserReserveIncentiveData {
    address underlyingAsset;
    UserIncentiveData spTokenIncentivesUserData;
...
interface ISparkProtocolDataProvider is IPoolDataProvider {
    ...
    // @notice Mentioned as getATokenTotalSupply in Spark's deployed contract
