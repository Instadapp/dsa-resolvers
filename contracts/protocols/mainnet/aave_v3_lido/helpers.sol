...
contract AaveV3Helper is DSMath {
    ...
    function getPoolAddressProvider() internal pure returns (address) {
        return 0xcfBf336fe147D643B9Cb705648500e101504B16d; //Mainnet PoolAddressesProvider address
    }
    ...
    function getPoolDataProvider() internal pure returns (address) {
        return 0xa3206d66cF94AA1e93B21a9D8d409d6375309F4A; //Mainnet PoolDataProvider address
    }
    ...
    function getUiIncetivesProvider() internal pure returns (address) {
        return 0xB3a0fA312853A8E24C7756e6857cD56592b24c99;
    }
