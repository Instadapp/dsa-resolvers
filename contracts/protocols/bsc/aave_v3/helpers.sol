...
contract AaveV3Helper is DSMath {
     ...
     */
    function getWbnbAddr() internal pure returns (address) {
        return 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // WBNB Address
    }
    ...
    function getAaveOracle() internal pure returns (address) {
        return 0x39bc1bfDa2130d6Bb6DBEfd366939b4c7aa7C697; //BSC address
    }

    /**
     *@dev Returns Chainlink Feed Address - BNB/USD Feed
     */
    ...
    function getRewardsController() internal pure returns (address) {
        return 0xC206C2764A9dBF27d599613b8F9A63ACd1160ab4;
    }
