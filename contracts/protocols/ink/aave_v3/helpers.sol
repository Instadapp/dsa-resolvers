...
contract AaveV3Helper is DSMath {
    ...
    function getWethAddr() internal pure returns (address) {
        return 0x4200000000000000000000000000000000000006; //Ink WETH Address
    }
    ...
    function getAaveDataProvider() internal pure returns (address) {
        return 0x96086C25d13943C80Ff9a19791a40Df6aFC08328; //Ink Tydro address
    }

    function getAaveIncentivesAddress() internal pure returns (address) {
        return 0xD93e3Ae8f69D04d484d1652Ca569d4b0522414DF; //Ink Tydro IncentivesProxyAddress
    }
    ...
    function getAaveOracle() internal pure returns (address) {
        return 0x4758213271BFdC72224A7a8742dC865fC97756e1; //Ink Tydro address
    }

    function getUiIncetivesProvider() internal pure returns (address) {
        return 0x25Ec457d1778b0E5316e7f38f3c22baF413F1A8C;
    }

    // Ink has no native Chainlink ETH/USD feed; Tydro's WETH oracle implements AggregatorV3Interface.
    ...
    function getRewardsController() internal pure returns (address) {
        return 0xD93e3Ae8f69D04d484d1652Ca569d4b0522414DF;
    }
